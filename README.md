...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b0e2ca17-3370-43b3-bbb8-3b575994410f
```

> `b0e2ca17-3370-43b3-bbb8-3b575994410f` is the password of the certificate, you can change it to any password you want.
...
* `Acme.BookStore.Application.Tests`: Application layer tests.
* `Acme.BookStore.Domain.Tests`: Domain layer tests.
* `Acme.BookStore.EntityFrameworkCore.Tests`: Entity Framework Core integration tests.
